...
class TaiwanMap extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <div>
                    <svg version="1.1" id="tw-map" x="0px" y="0px" viewBox="352 -439.3 1038 1221.1" style="enable-background:new 352 -439.3 1038 1221.1;" className="tw-map">
                        <path id="Outlying-island" className="st0" d="M647.4-158.2H402.3v-245.1h245.1V-158.2z M647.4-160.8H402.3V84.3h245.1V-160.8z
         M647.4,83.1H402.3v245.1h245.1V83.1z"></path>
                        <path id="tw-map-15" className="st1" d="M1070.4,282.7l1.9,5.8l-3,5l-5.6,2.4l-1.4,3.2l1,4l5.6,3.6l6.3,5.2l2.8,7.6l0.3,2.5l-15.6,3.8
        ...
        l18.5-9.4l4.3,1l5.8,2.2l4.2,5.9L1070.4,282.7L1070.4,282.7z"></path>
                        <path id="tw-map-16" className="st1" d="M900,591.4l2,2.9l-0.3,1l-2.7,1.8l-5,4.3l-0.9-3.3l1.4-2.7l2.8-3.6h2L900,591.4L900,591.4z
        ...
        l13.1,6.6l6.6-5.9l7.2-1.8l7.6,8.9l5.9,5.5l8.5-6.7l4.3-0.2L1026.7,448.1L1026.7,448.1z">
                        ...
                        <path id="tw-map-14" className="st1" d="M814.4,393.7l-0.6,1.2l-2.3-2l-1.7-4.2l0.3-1.3h0.7l0.9,1.2l0.7,1.9l2.1,2.2L814.4,393.7
        ...
        L974.2,342.3z"></path>
                        <path id="tw-map-5" className="st1" d="M1054.9-85.6l-0.2,0.2l-4.6,1.1l-4.4-1.7l-2.7-3.8l-4.3-2.6l-6.9-2.7l1.2-4.1l5.5-11.4l2.2-3
        ...
        l-3.4,4.3l-2.3,5.6L1054.9-85.6L1054.9-85.6z"></path>
                        <path id="tw-map-6" className="st1" d="M1173.7-51l-2.3,6.5l-1.4,4.7l0.6,4.4l-3.8,5.8l-14,14.2l-4.3,10.5l-2.8-0.8l-10.6,1l-0.8,0.6
        ...
        l2.6,4.5l4.3,2.2l3.4,2.6l0.4,5l1.6,7.3l-1.9,7.8l-4.6,6.5l0.5,4.3l5.2,3.9l6.2,3.8l5.5,0.9l4,2.9l7.3,4.1L1173.7-51L1173.7-51z" style="fill: rgb(255, 255, 255);"></path>
                        <path id="tw-map-19" className="st1" d="M1313-125.7l2.1,0.5l1.6,2.2l-0.7,2.3l-3.8-0.1l-1.4-0.8l-1.7-2.7l0.9,0.3L1313-125.7
        ...
        l-0.5,1.4L1266,26.9L1266,26.9z"></path>
                        <path id="tw-map-1" className="st1" d="M1265.4-209.6l-0.3,11.9l0.2,3l3.7,3.9l-0.4,2.5l-2.5,1.8l-4,1.5l-5.1-0.6l-10.6-4.4l-3-2.2
        l-3.7-3.4l-2.8-3.5l-1.7-3.5l-2.9-3.7l-0.6-2.9l3.2-2.2l7.2-3.1l4.4-2.9l1.4,0.9l2.4,2.7l3.9,1.4L1265.4-209.6L1265.4-209.6z">
                        </path>
                        <path id="tw-map-7" className="st1" d="M1054.9-85.6l4.4,11.1l3.9,4.4l6,4.5l12.1,5.7l3.9,3.4l0.7,5.2l-0.3,3.9l-0.8,3.5l-1,3.1l1,2.9
        ...
        l4.3,2.6l2.7,3.8l4.4,1.7l4.6-1.1L1054.9-85.6L1054.9-85.6z" style="fill: rgb(255, 255, 255);"></path>
                        <path id="tw-map-2" className="st1" d="M1228-161.4l-4.2,1.7l-5.8-0.1l-4.8-1l-3.7-3.3l-3.8-4.3l-5.8-4.6l-3.9-6.7l1.5-7.4l-1.2-6.3
        ...
        l1.6,4.4l-1.6,6.6l0.1,5.1l4.6,2.6l3.8,3.2l-2,4.3L1228-161.4L1228-161.4z"></path>
                        <path id="tw-map-3" className="st1" d="M1246.5-217.4l-4.4,2.9l-7.2,3.1l-3.2,2.2l0.6,2.9l2.9,3.7l1.7,3.5l2.8,3.5l3.7,3.4l3,2.2
        ...
        L1228-161.4L1228-161.4z"></path>
                        <path id="tw-map-4" className="st1" d="M1192.4-75.8l-3.1,0.9l-5.4,3.9l3.1,12.4l-2.2,3.8l-3.4,1.3l-3.3-0.6l-3.9,1.6l-0.5,1.5l-4.8-2.2
        ...
        l-1.5,5.3l-3.1,3.7l0.8,5.2l1.4,5.6l8.9,8.5L1192.4-75.8L1192.4-75.8z"></path>
                        <path id="tw-map-9" className="st1" d="M977.8,115l0.1,3.6l-4.3,1.6l-1.2,2.9l0.5,4l-2,4.6l-1.6,5.4l-0.1,5.7l-1.2,6.6l-0.9,13.4
        ...
        l0.1,4l1.2,3.3l4.3,0.8l5.4,3.5V115L977.8,115z" style="fill: rgb(255, 255, 255);"></path>
                        <path id="tw-map-13" className="st1" d="M830.2,318.6l-1.8,1.4l-0.4-1.1l2.4-3.1l0.9-2.4l1.1-1.5l0.6,0.5l0.1,1.1l-1.4,2L830.2,318.6
        ...
        l6.8-2.7l4.5-0.6l3-2.2l-2.5-6.8l-2.5-4l-4.1-2.2l-5.6-2.1l-7.8,0.7L904.4,261.9L904.4,261.9z"></path>
                        <path id="tw-map-12" className="st1" d="M904.4,261.9l9.3-1.6l7.8-0.7l5.6,2.1l4.1,2.2l2.5,4l2.5,6.8l-3,2.2l-4.5,0.6l-6.8,2.7l-7.3-1.7
        l-7-4.5l-6.1-2.4l-0.9-5.6L904.4,261.9L904.4,261.9z"></path>
                        <path id="tw-map-18" className="st1" d="M1266,26.9l0.6,0.8l1.6,2.9l0.2,1.1l-1.4,2.4l-5.8,5.7l-6.2,8.6l-4.7,3.7l-1.4,2l0.7,2.1
        ...
        l0.4-4.2l4.7-4.9l2.5,2.1l6.5,3.1l15,3.8l8.3,3.2h6.5l4.9-4.5l2.4-6l3.8-0.9l18.5,11.1l11.1,1.7L1266,26.9L1266,26.9z">
                        ...
                        <path id="tw-map-10" className="st1" d="M1155.6,53l1.4,6.2l0.2,3.7l-5.2,2.4l-6.6,2.2l-3.7,2.9l0.2,9.9l2.9,3.1l5.2,3.4l1.5,4.5
        ...
        z" style="fill: rgb(255, 255, 255);"></path>
                        <path id="tw-map-8" className="st1" d="M1134.3-4.1l0.8-0.6l10.6-1l2.8,0.8l3.6,1l-0.6,5.5l1.4,3.8l4.9,1l4.4,2.6l3.7,2.5l4-0.6l4.7-2.3
        ...
        l6,2.4l5,5.6l5.4,2.1l8.9-4.7l6.8-2.9l11.6-9.2l5.9-3.2l4.6-4.4l4.2-3l5.3,0.1l4.9-2l1.8-5.6L1134.3-4.1L1134.3-4.1z" style="fill: rgb(255, 255, 255);"></path>
                        <path id="tw-map-11" className="st1" d="M972.6,185.6l1.9,7.2l-2,4.7l-1,7.2l1,7.7l-1.9,5.2l-0.9,5.7l4,4.7l5.8,2.5l6.8-2l8.2-0.9
        ...
        l11.6,4.4l19.7,2.3l12.2,6l5.8-0.1l12,2.4L972.6,185.6L972.6,185.6z"></path>
                        <path id="tw-map-17" className="st1" d="M1219.8,688.4l-5.5,1.7l-7.3-2.9l-6.8-4.8l-3.9-3.7l1.2-2.7l-0.1-2.5l-1-2.4l-1.7-2.1h19.5v1.8
        ...
        l-1.7,16.1L1032.7,624.9L1032.7,624.9z"></path>
                        <path id="tw-map-20" className="st1" d="M494.3,295.6l-1.8,0.9l-1.3-1.5l-1.5-4.7l1-1.2l3.8-1.3l2.7,0.7l0.1,2.1l-0.2,1.6l-1.2,1.2
        ...
        l-0.3,0.9l-1.3-3l-0.2-1.4l1.8-1.5l1.6-3l0.5,1.1l2.5,1.4l-0.4,1.8l-2.2,1.3L539,142z"></path>
                        <path id="tw-map-21" className="st1" d="M444.4,27.5l-5.2,1.5l-3-1.2l5-9.9l1.3-1.4l2.1-0.5l2.1-0.1l2,1.4l1.6,1.8v3.1l-1.4,2.1
        ...
        l0.2,1.9L575.3-106.1L575.3-106.1z"></path>
                        <path id="tw-map-22" className="st1" d="M466.9-215.5l-0.2,2.3l-1.9,2.1l-4.1,2l2.5-5.6l2.5,0.5l0.1-0.9L466.9-215.5z M455.1-216.3
        ...
        l1.3,1.9L473.2-289L473.2-289z M603-334.6l-1.2,0.4l-1.1-0.4l-1.4,1.3l-1.1,2.1l-0.3-0.5l-1.2-0.2l-1.8-1l1.1-1.7l-0.5-1.4l0.9-0.6
          l2.2-1.8l2.6,1.5l0.6,1.3L603-334.6z"></path>
                    ...
                    <div className="tooltip-box">
                        <span id="city-name"></span><span id="city-case-num"></span>
                    </div>
                </div>
            </React.Fragment>
        );
