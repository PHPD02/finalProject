                ...
                <div id='registerform'>
                    <form className="form-signin shadow" id='registerformin'>
                        ...
                        {/* <div className="container my-4">
                            <div className='row'>
                                <input type="email" id="inputEmail" className="form-control col-6" placeholder="姓" required autoFocus />
                                <input type="email" id="inputEmail" className="form-control col-6" placeholder="名" required autoFocus />
                            </div>
                        </div>

                        <input type="email" id="inputEmail" className="form-control" placeholder="密碼" required autoFocus /> */}
