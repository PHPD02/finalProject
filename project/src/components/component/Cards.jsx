      ...
      <React.Fragment>
            <div style={{width:'200px',height:'250px'}}>
              <div className="setHeight cardshadow">
                {/* 需要套資料庫呈現(圖片) */}
                <div className='zImg'>
                  <img src="./image/foodtraditional.png" className="bd-img bd-img-lg featurette-image img-fluid mx-auto" id="myImg" width="100%" height=""/>
                </div>
                ...
                <div className="zText">
                  {/* 店家名稱 */}
                  <div className='row'><b className="col-7 text-nowrap text-truncate"></b>
