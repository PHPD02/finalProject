...
function DashboardProducts_tryifunctioncomponent() {
  ...
  return (
    <div>
                    ...
                    <li>
                      <a href="#">
                        <div className="notification-content">
                          ...
                          <div className="notification-text">新增一筆訂單</div>
                        </div>
                      </a>
                    </li>
                    <li>
      ...
      <button className="btn btn-primary  addproduct" onClick={addProduct}>
        添加商品
      </button>
    </div>
  );
...
export default DashboardProducts_tryifunctioncomponent;
