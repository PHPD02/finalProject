...
class StoreSlidrBar2_west extends React.Component {
  state = {
    restaurantsList: [],
  };

  async componentDidMount() {
    var result = await axios.get("http://localhost:8000/restaurants/category/west");
...
export default StoreSlidrBar2_west;
